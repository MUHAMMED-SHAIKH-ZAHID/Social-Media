...
import { addReport } from '../Redux/features/PostSlice'
...
function Report({ close, postid }) {
    ...
    const testing=()=>toast.error("shaikhhhh")
    ...
    const handleReport = () => {
        ...
        dispatch(addReport({ postid, reason })).then((res) => {
            ...
            if(res.payload.has_report){
                console.log("has report is working perfectly fine in the toast",res.payload.has_report);
                hasReportNotify()
            }
    ...
    return (
        ...
        <div className='fixed inset-0 bg-black backdrop-blur-sm bg-opacity-30  flex justify-center items-center  z-50'>
            ...
            <div className='bg-gray-900 rounded-3xl w-96 h-96 flex justify-center border-2  text-white'>
                ...
                <div className='px-6 py-5 rounded-md mt-5'>
                    ...
                    <div className='mt-5 text-xl items-center font-sans'>
                        ...
                        <button onClick={()=>testing()}>test toast</button>
                    </div>
